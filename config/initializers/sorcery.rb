...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    # Default: `[:email]`
    #
    user.username_attribute_names = [:username, :phone_number]
    ...
    # the attribute name to hold activation code (sent by email).e
    ...
    # UserAccount's identifier in authentications class.
    # Default: `:user_id`
    #
    ...
    # UserAccount's external unique identifier in authentications class.
    # Default: `:uid`
    #
